...
const REDIRECT_URI = "https://42e3-186-11-97-80.ngrok-free.app/payment/mercadopago/oauth/callback";
...
const MP_CLIENT_ID = "3932883698958169";
const REDIRECT_URI = "https://6023-181-42-221-199.ngrok-free.app/payment/mercadopago/oauth/callback";
const userId = localStorage.getItem("userId");
const state = JSON.stringify({ userId });
const authUrl = `https://auth.mercadopago.cl/authorization?client_id=${MP_CLIENT_ID}&response_type=code&platform_id=mp&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&state=${encodeURIComponent(state)}`;
...
<h2>Mi Tienda</h2>
  <button className="connect-mp-button" onClick={handleConnectMP}>
